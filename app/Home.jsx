...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const rpcEndpoint =
      "https://api.developer.coinbase.com/rpc/v1/base/2PSK07gMRzE8bNLRwGnGo7r6tC6-DuzO";

    const ethereumProvider = walletLink.makeWeb3Provider(
      rpcEndpoint,
      baseChainId,
    );
      ...
      <main className="flex items-center justify-center bg-ocsblue fixed w-screen h-screen overflow-hidden">
        <div className="relative flex flex-col items-center justify-center w-full h-full">
          ...
          <div className="relative flex items-center justify-center mt-6 z-10">
            <div
              className="absolute z-10 flex items-center justify-center text-white text-5xl font-bold responsive-ocs"
              style={{
                top: "5%",
              ...
              {status === "connected" && (
                <div
                  ...
                  style={
                    showGif
                      ? {
                          backgroundImage: `url(/img/bald.gif)`,
                          backgroundSize: "cover",
                          backgroundPosition: "center",
                        }
                      : farcasterImage
                        ? {
                            backgroundImage: `url(${farcasterImage})`,
                            backgroundSize: "cover",
                            backgroundPosition: "center",
                          }
                        : ensName
                          ? {
                              backgroundImage: `url(https://euc.li/${ensName})`,
                              backgroundSize: "cover",
                              backgroundPosition: "center",
                            }
                          : {}
